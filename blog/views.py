...
#view function to delete session
...
#view function to save session data
...
#view function to access session data
...
def lousy_login(request):
    if request.method == 'POST':
        ...
        if username == "root" and password == "pass":
            ...
            return redirect('blog:lousy_secret')
        else:
...
#view function for lousy secret
...
#view function for lousy logout
...
#view fn to display a list of posts
...
#view fn to display a list of posts in detail
...
#view fn to display a post by category
